...
% 3. Set the appropriate preference parameters.
Params.beta0=0.85; % The 'first' quasi-hyperbolic discounting parameter (controls discounting between 'today and tomorrow')
Params.beta=1.011; % The 'second' quasi-hyperbolic discounting parameter (note that once combined with the survival probabilites this give a discount factor that is typically less than one).
% Quasi-hyperbolic discounting is sometimes refered to as 'alpha-beta'
% discounting. In this case alpha would refer to beta0 (and beta is beta :).

% 4. Minor adjustment to 'discount factors'.
% For quasi-hyperbolic preferences the last element of DiscountFactorParamNames must be the 'today-to-tomorrow' discount factor.
